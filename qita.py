...
with open("itv.txt", 'r', encoding='utf-8') as file:
    ...
    for line in lines:
        ...
        if line:
            ...
            if '卫视' not in channel_name and 'CCTV' not in channel_name and '河南' not in channel_name and '测试' not in channel_name and '医院' not in channel_name and '院内' not in channel_name:
...
with open("qita.txt", 'w', encoding='utf-8') as file:
    ...
    for result in results:
        ...
        if 'CCTV' not in channel_name and '卫视' not in channel_name and '河南' not in channel_name and '许昌' not in channel_name and '测试' not in channel_name:
...
# 合并文件内容
file_contents = []
file_paths = ["cctv.m3u", "weishi.m3u", "hn.m3u","qita.m3u"]  # 替换为实际的文件路径列表
for file_path in file_paths:
    with open(file_path, 'r', encoding="utf-8") as file:
        content = file.read()
        file_contents.append(content)
