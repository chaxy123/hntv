...
with open("hnitv.txt", 'r', encoding='utf-8') as file:
    ...
    for line in lines:
        ...
        if line:
            ...
            if '河南' in channel_name and '梨园' in channel_name and '戏曲' in channel_name and '许昌' in channel_name and '郑州' in channel_name:
